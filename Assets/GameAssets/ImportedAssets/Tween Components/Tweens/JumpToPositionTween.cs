...
namespace TweenComponents
{
    public class JumpToPositionTween : TweenBase
    {
        ...
        public override void Execute(bool straight = true)
        {
            ...
            {
                _tween = TransformToChange.DOLocalJump(_positionToExecute, JumpForce, JumpsCount, Duration)
                    .ApplyBaseSettings(this, TransformToChange.gameObject);
            }
            else
            {
                _tween = TransformToChange.DOJump(_positionToExecute, JumpForce, JumpsCount, Duration)
                    .ApplyBaseSettings(this, TransformToChange.gameObject);
            }
        }
